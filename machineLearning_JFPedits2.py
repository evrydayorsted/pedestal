...
# plt.show()
plt.savefig("feature_importance_deltabetaped_MASTU.pdf",bbox_inches='tight', pad_inches=0.1)
...
# plt.show()
plt.savefig("permutation_importance_deltabetaped_MASTU.pdf",bbox_inches='tight', pad_inches=0.1)
