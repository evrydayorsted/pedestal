...
failedShotNums = [47956,47982, 48071, 48156, 48291, 49063 , 49069]
...
# failed guns
def pickleCombine(shotNums = allShotNums, failedShotNums = failedShotNums, folder = "outputWithBeamPower4", outfileName = "MAST-U_pedestal_allShots"):
    """
